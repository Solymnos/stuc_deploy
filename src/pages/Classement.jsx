...
let teams  = 
[
  { 'name' : 'POLARY', 'icon' : './img/logo/Polary.png', 'pts' : '10', 'pts_quizz' : '10', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'CALECON FREEGUN', 'icon' : './img/logo/CF.png', 'pts' : '8', 'pts_quizz' : '8', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'LOST AUTISTOS 93', 'icon' : './img/logo/LA93.png', 'pts' : '8', 'pts_quizz' : '8', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'GG CALL DOG', 'icon' : './img/logo/GGCDO.png', 'pts' : '6', 'pts_quizz' : '6', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'NULARY', 'icon' : './img/logo/nulary.png', 'pts' : '5', 'pts_quizz' : '5', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'SLYP', 'icon' : './img/logo/SLYP.png', 'pts' : '4', 'pts_quizz' : '4', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'GG CALL DRAKE', 'icon' : './img/logo/GGCDR.png', 'pts' : '3', 'pts_quizz' : '3', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'EXODIA', 'icon' : './img/logo/Exodia.png', 'pts' : '2', 'pts_quizz' : '2', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
  { 'name' : 'UNO', 'icon' : './img/logo/UNO.png', 'pts' : '1', 'pts_quizz' : '1', 'pts_ftn' : '?', 'pts_ssbu' : '?', 'pts_tft' : '?', 'pts_rl' : '?'},
]
